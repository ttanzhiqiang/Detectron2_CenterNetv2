...
namespace Detectron2
{
  ...
  void CocoAnn::load_annotation(json &json_ann){
    ...
    //std::map<int64_t, std::vector<torch::Tensor>> gt_seg;
...
//
  ...
  */
  void CocoDataset::transform(ImgData &img_data){
    ...
    //std::cout << img_data.gt_bboxes << std::endl;
    ...
    //{
    //    img_data.gt_seg[i_gt_seg] = img_data.gt_seg[i_gt_seg] * img_data.scale_factor_w;
    //    //std::cout << "img_data.gt_seg" << img_data.gt_seg[i_gt_seg] << std::endl;
    //}
